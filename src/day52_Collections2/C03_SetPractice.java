package day02_MyfirstProgram.src.day52_Collections2;
...
public class C03_SetPractice {
    public static void main(String[] args) {
        ...
        hashSet.addAll(Arrays.asList(10,200,30,400,50,600,70,15,90,30,100));
        hashSet.addAll(Arrays.asList(10,200,30,400,50,600,70,15,90,30,100));
        hashSet.addAll(Arrays.asList(null,null,null,null));     // null kabul ediyor
        ...
        linkedHashSet.addAll(Arrays.asList(10,200,30,400,50,600,70,15,90,30,100));
        linkedHashSet.addAll(Arrays.asList(10,200,30,400,50,600,70,15,90,30,100));
        linkedHashSet.addAll(Arrays.asList(null,null,null,null));   // null kabul ediyor
