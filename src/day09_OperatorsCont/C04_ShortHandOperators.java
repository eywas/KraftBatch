...
public class C04_ShortHandOperators {
    public static void main(String[] args) {
        ...
        odenecekTutar&=10;
        System.out.println("1130TL için: "+ikiyuzluk+" tane ikiyüzlük banknot "+yuzluk+
                " tane yüzlük banknot "+yirmilik+" tane yirmilik banknot "+onluk+ " tane onluk banknot ödemeniz gerekmektedir.");
