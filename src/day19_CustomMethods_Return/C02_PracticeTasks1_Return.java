...
public class C02_PracticeTasks1_Return {
    public static void main(String[] args) {
        ...
        System.out.println("----------------------------------");
        System.out.println(eligibleForAlcoholPurchase(43));
        System.out.println("----------------------------------");
        System.out.println(eligibleToVote(43, "tr"));
        System.out.println("----------------------------------");
        System.out.println(grades(97));
        System.out.println("----------------------------------");
        System.out.println(areaOfCircle(2));
        System.out.println("----------------------------------");
...
//    1. create a method that can print odd numbers between 1~100 in a same line saperated by space
    ...
    /**
     * a method that returns a string of odd numbers between 1~100 in a same line saperated by space
     */
...
//    2. create a method that can print even numbers between 1~100 in a same line saperated by space
    ...
    /**
     * a method that returns a string of even numbers between 1~100 in a same line saperated by space
     * @return
     */
...
////                You are not eligible to vote!
    ...
    /**
     * a method that returns a boolean if a person is eligible to vote
     *
     * @param age
     * @param citizenship
     */
...
// score < 60 grade 'F'
    ...
    /**
     * a method that returns calculate the grade of the student based on the score
     * score >= 90 grade 'A'
     * score >= 80 grade 'B'
     * score >= 70 grade 'C'
     * score >= 60 grade 'D'
    ...
    /**
     * a method that returns calculate the area of a circle
     *
     * @param radius
     */
    public static double areaOfCircle(int radius) {
        double area;
        area = Math.round(Math.PI * radius * radius * 100) / 100.0; // Küsuratı iki haneli yazdırmak için *100/100.0 yazdık
        return area;
    }
//    7. create a method that can calculate the area of a square

    /**
     * a method that returns calculate the area of a square
     *
     * @param side
     */
...
//    8. create a method that can convert dollar to TL rate:19.04
    ...
    /**
     * a method that returns convert dollar to TL rate:19.04
     *
     * @param dollar
     */
